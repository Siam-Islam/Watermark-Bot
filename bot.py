...
async def SettingsBot(bot, cmd):
	...
	elif watermark_position == "main_w-overlay_w-5:3":
	...
	await cmd.reply_text(
		...
		reply_markup=InlineKeyboardMarkup(
			[
				...
				[InlineKeyboardButton("Set Top Left", callback_data=f"position_5:5"), InlineKeyboardButton("Set Top Right", callback_data=f"position_main_w-overlay_w-5:3")],
