...
async def SettingsBot(bot, cmd):
	...
	elif watermark_position == "main_w-overlay_w/2:main_h-overlay_h-20":
	...
	await cmd.reply_text(
		...
		reply_markup=InlineKeyboardMarkup(
			[
				...
				[InlineKeyboardButton("Set Bottom Left", callback_data=f"position_5:main_h-overlay_h"), InlineKeyboardButton("Set Bottom Right", callback_data=f"position_main_w-overlay_w/2:main_h-overlay_h-20")],
